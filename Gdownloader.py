import sys
from PyQt6.QtWidgets import QApplication, QWidget, QVBoxLayout, QPushButton, QTextEdit, QLabel, QLineEdit, QFileDialog, QProgressBar, QInputDialog
...
class YouTubeDownloaderApp(QWidget):
    ...
    def download_videos(self):
        ...
        self.download_worker = DownloadWorker(video_url, download_path)
